...
def withdraw(withdrawal_api: WithdrawalApi, amount: float, address: str, currency: str, chain: str):
    amount = str(amount)
    try:
        ledger_record = LedgerRecord(amount=amount, address=address, currency=currency, chain=chain)
...
def withdraw_many(
    ...
    for address in addresses:
        ...
        withdraw(withdrawal_api, amount, address, currency, chain)
        sleep(3)
